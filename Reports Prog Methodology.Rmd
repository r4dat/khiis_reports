...
The "Raw Report Tables" file has been left intact for testing purposes. Use the modular for m in production, notably field ordering for gallbladder procedure tables differ between the two versions, and down-stream processing relies on the newer ordering within Modular_Report_Call.
